		...
		<div class="av_promobox  avia-button-yes  ">		<div class="avia-promocontent"><p></p>
<h5>Get in touch for pricing or to speak to a Coffey Testing member</h5>
<p>
</p></div><div class="avia-button-wrap avia-button-right "><a href="/request-a-quote/" class="avia-button   avia-icon_select-yes-left-icon avia-color-custom avia-size-large avia-position-right " style="background-color:#EB6E07; border-color:#EB6E07; color:#ffffff; "><span class="avia_button_icon avia_button_icon_left " aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span><span class="avia_iconbox_title">REQUEST A QUOTE</span></a></div>	</div>
		</div>
			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    <div class='container'>
                        ...
                        <span class='copyright'>&copy; <?php echo date("Y"); ?> Coffey Testing. All Rights Reserved. | <a href="/privacy-policy/">Privacy Policy</a> </span>
...
<a href="https://coffeytesting.com.au/job-application/" id="job-application">Apply Now</a>
